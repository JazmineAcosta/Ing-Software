...
<head>
  ...
  <!-- Tablas -->
  <link href="https://cdn.datatables.net/v/bs5/jq-3.7.0/jszip-3.10.1/dt-1.13.8/e-2.2.2/af-2.6.0/b-2.4.2/b-html5-2.4.2/b-print-2.4.2/date-1.5.1/sl-1.7.0/sr-1.3.0/datatables.min.css" rel="stylesheet">

  <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/pdfmake.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js"></script>
  <script src="https://cdn.datatables.net/v/bs5/jq-3.7.0/jszip-3.10.1/dt-1.13.8/e-2.2.2/af-2.6.0/b-2.4.2/b-html5-2.4.2/b-print-2.4.2/date-1.5.1/sl-1.7.0/sr-1.3.0/datatables.min.js"></script>
...
<body>
                ...
                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                  ...
                  <form class="row g-3 needs-validation" id="profileForm">
                    ...
                    <div class="mb-3 text-center">
                      <label for="profileImage" class="col-md-12 col-form-label">Usuario</label>
                      <div class="col-md-12">
                        <img id="profileImg" src="../librerias/assets/img/sin-perfil.png" alt="Profile" />
                        <div class="pt-2">
                          <input type="file" name="foto_empleado" id="fileInput" style="display: none;" accept="image/*">
                          <a href="#" class="btn btn-primary btn-sm" title="Subir nueva foto" id="uploadBtn">
                            <i class="bi bi-upload"></i> Cargar
                          </a>
                          <a href="#" class="btn btn-danger btn-sm" title="Remover foto" id="removeBtn">
                    ...
                    <div class="col-md-6">
                      <label for="validarFechaNacimiento" class="form-label">Fecha de nacimiento</label>
                      <input type="date" class="form-control" id="validarFechaNacimiento" required />
                      <div id="feedback-message" class="invalid-feedback"></div>
                    </div>
              ...
              <h5 class="card-title d-flex justify-content-between align-items-center">
                ...
                <div class="ms-auto">
                  <button type="button" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Exportar a PDF">
                    <a href="../modelo/pdf-empleados.php" target="_blank" style="color: white; text-decoration: none;">
                ...
                <tbody>
                  <?php while ($empleado = $empleados->fetch_assoc()) { ?>
                    <tr>
                      ...
                      <td><?php echo $empleado["nom_ape_empleado"] ?></td>
                      <td><?php echo $empleado["direc_empleado"] ?></td>
                      <td><?php echo $empleado["email_empleado"] ?></td>
                      <td><?php echo $empleado["tel_empleado"] ?></td>
                      <td><?php echo $empleado["fecha_naci_empleado"] ?></td>
                      <td>
                        <?php if ($empleado["estado_empleado"] == 'A') { ?>
                          <span class="badge bg-success">
                            <i class="bi bi-check-circle me-1"></i> Activo
                          </span>
                        <?php } elseif ($empleado["estado_empleado"] == 'I') { ?>
  ...
  <!-- Cargar imagen y enviar formulario -->
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var defaultImageUrl = "../librerias/assets/img/sin-perfil.png";
      ...
      document.getElementById("saveChangesBtn").addEventListener("click", function(event) {
        // Add your logic here to submit the form with the image data (e.g., using AJAX)
      });
    });
  </script>
  <!-- Fin cargar imagen y enviar formulario -->
